    ...
    class PatientTableTests
    {
        ...
        public void SetupTest()
        {
            ...
            using (SqlConnection myConnection = ConnectionsManager.GetNewConnection())
            {
                ...
                string populationQuery1 = "INSERT INTO patients (nameLast, nameFirst, nameMiddle, street, city, state, zip, " +
                ...
                string populationQuery2 = "INSERT INTO patients (nameLast, nameFirst, nameMiddle, street, city, state, zip, " +
                    "phoneHome, areaCodeHome, phoneWork, areaCodeWork, phoneMobile, areaCodeMobile, familyDoctor) " +
                    "VALUES ('Burcham', 'David', 'A', 'B', 'B', 'B', '22222', '2222222', '256', '2222222', '256', '2222222', '256', 'B')";
                string populationQuery3 = "INSERT INTO patients (nameLast, nameFirst, nameMiddle, street, city, state, zip, " +
                    "phoneHome, areaCodeHome, phoneWork, areaCodeWork, phoneMobile, areaCodeMobile, familyDoctor) " +
