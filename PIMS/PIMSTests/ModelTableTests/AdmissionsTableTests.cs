...
namespace PIMSTests.ModelTableTests
{
    ...
    class AdmissionsTableTests
    {
        ...
        public void SetupTest()
        {
            ...
            myList.Clear();
            myList.Add(new Admission(DateTime.Parse("01/01/2017"), DateTime.Parse("12/01/2017"), "A", "A", "1", "1", "1", "1", 1, 1));
            myList.Add(new Admission(DateTime.Parse("01/02/2017"), DateTime.Parse("12/02/2017"), "B", "B", "2", "2", "2", "2", 2, 2));
            myList.Add(new Admission(DateTime.Parse("01/03/2017"), DateTime.Parse("12/03/2017"), "C", "C", "3", "3", "3", "3", 3, 3));
        ...
        public void ShouldUpdateList()
        {
            ...
            Admission updated1 = new Admission(DateTime.Parse("01/01/2017"), DateTime.Parse("12/01/2017"), "D", "D", "1", "1", "1", "1", 1, 1);
            Admission updated2 = new Admission(DateTime.Parse("01/02/2017"), DateTime.Parse("12/02/2017"), "E", "E", "2", "2", "2", "2", 2, 2);
            Admission updated3 = new Admission(DateTime.Parse("01/03/2017"), DateTime.Parse("12/03/2017"), "F", "F", "3", "3", "3", "3", 3, 3);
