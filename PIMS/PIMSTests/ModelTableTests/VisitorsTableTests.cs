    ...
    class VisitorsTableTests
    {
        ...
        public void SetupTest()
        {
            ...
            using (SqlConnection myConnection = ConnectionsManager.GetNewConnection())
            {
                ...
                string clearQuery = "DELETE FROM visitors DBCC CHECKIDENT('visitors', RESEED, 0)";
        ...
        public void ShouldUpdateList()
        {
            ...
            Visitors updated1 = new Visitors("test4", "test4", "test4", DateTime.Parse("01/04/2017"), 4, 1);
            Visitors updated2 = new Visitors("test5", "test5", "test5", DateTime.Parse("01/05/2017"), 5, 2);
            Visitors updated3 = new Visitors("test6", "test6", "test6", DateTime.Parse("01/06/2017"), 6, 3);
        ...
        public void ShouldUpdateItem()
        {
            ...
            // Need some updated data
            Visitors updatedVisitor = new Visitors("test4", "test4", "test4", DateTime.Parse("01/04/2017"), 4, 1);
